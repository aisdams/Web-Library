...
<header class="header">
    ...
    <div class="header-1">
        ...
        <div class="icons">
            ...
            <a href="/login"><button style="margin-left: 10px;background: #219150; border: none;width: 135px;height: 30px;border-radius: 10px;color: white;cursor: pointer">Login</button></a>
        </div>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box">
                ...
                <div class="content">
                    ...
                    <div class="price">free <span>free</span></div>
